...
export const REFRESH_BEFORE_EXPIRY_SEC = 60; // 1 minute
...
export const GOOGLE_AUTH_URL = "https://account.google.com/o/oauth2/v2/auth";

console.log({GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GOOGLE_REDIRECT_URI , GOOGLE_AUTH_URL})
