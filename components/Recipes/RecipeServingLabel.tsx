...
export default function RecipeServingLabel(
    { serving, grams_per_portion }:
    {
      serving: Record<string, string | number>,
      grams_per_portion: string | number | undefined | null
    }
  ) {
      ...
      <View px="$3" py="$2">
        ...
        {grams_per_portion ?
          <View flexDirection="row" style={{ justifyContent: "space-between" }} mb="$2">
            ...
            <Text fontSize={14} fontWeight="600" color="#000">{cutDecimals(grams_per_portion)} g</Text>
          </View> : null
        }
